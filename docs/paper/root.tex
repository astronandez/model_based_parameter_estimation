...
\author{Marc Hernandez$^{1}$ and Tilboon Elberier$^{2}$% <-this % stops a space
\thanks{*This work was not supported by any organization}% <-this % stops a space
\thanks{$^{1}$Marc Hernandez is a Phd Student in Electrical and Computer Engineering, Mathematics and Computer Science,
